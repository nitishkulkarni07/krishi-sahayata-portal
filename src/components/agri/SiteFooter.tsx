    ...
    <footer className="border-t border-border bg-background">
      <div className="mx-auto max-w-[1440px] px-4 md:px-8 py-16 md:py-20">
          ...
          <div className="md:col-span-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-medium">Department of Agriculture<br/>& Farmers Welfare</p>
              </div>
            </div>
            ...
            <p className="mt-4 font-mono text-xs text-muted-foreground">
              Helpline: <span className="text-foreground">1800-180-1551</span>
            </p>
          </div>
        ...
        <div className="mt-16 flex flex-col items-start justify-between gap-4 border-t border-border pt-8 md:flex-row md:items-center">
          <p className="font-mono text-[10px] uppercase tracking-widest text-muted-foreground">
            © 2026 Ministry of Agriculture · Designed by NIC
          </p>
